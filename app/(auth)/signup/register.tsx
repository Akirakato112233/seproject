...
export default function RegisterScreen() {
    ...
    const params = useLocalSearchParams<{ email: string; displayName: string; googleId: string }>();
    ...
    const handleRegister = async () => {
        ...
        try {
            const response = await fetch(API.REGISTER_GOOGLE, {
                method: 'POST',
            ...
            if (response.ok && data.success) {
                ...
                // TODO: Store user data in AsyncStorage/Context
