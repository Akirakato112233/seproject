...
export const mockShops: any[] = [
    ...
    },
    {
        ...
        deliveryTime: 45,
        imageUrl:
            'https://images.unsplash.com/photo-1517677208171-0bc6799a6c6f?q=80&w=2070&auto=format&fit=crop',
        washServices: [
            {
                weight: 10,
                options: [
        ...
        dryServices: [
            {
                weight: 10,
                options: [{ setting: 'Standard Dry', duration: 45, price: 60 }],
            },
        ],
        ironingServices: [
            {
    ...
    },
    {
        ...
        deliveryTime: 30,
        imageUrl:
            'https://images.unsplash.com/photo-1582735689369-4fe89db236ea?q=80&w=2070&auto=format&fit=crop',
        washServices: [
            {
                weight: 7,
                options: [
        ...
        dryServices: [
            {
                weight: 7,
                options: [{ setting: 'Standard Dry', duration: 30, price: 30 }],
            },
        ],
    },
    {
        ...
        washServices: [
            {
                weight: 15,
                options: [{ setting: 'Luxury Care', duration: 90, price: 300 }],
            },
        ],
        ironingServices: [
            {
    ...
    },
    {
        ...
        washServices: [
            {
                weight: 12,
                options: [{ setting: 'Normal Wash', duration: 45, price: 60 }],
            },
        ],
        dryServices: [
            {
                weight: 12,
                options: [{ setting: 'Hot Dry', duration: 40, price: 50 }],
            },
        ],
    },
];
