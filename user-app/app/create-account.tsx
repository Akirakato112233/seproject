 ...
 * Uses expo-auth-session; on success sends accessToken to backend (GOOGLE_LOGIN).
 * Backend may return next: REGISTER (go to signup/register) or next: APP (login and go to tabs).
 */
export default function CreateAccountScreen() {
    ...
    // ---------- Send accessToken to backend for login/register ----------
            ...
            <View style={s.container}>
                <View style={s.header}>
                    ...
                    <Text style={s.subtitle}>
                        Sign in with your Google account to continue. We will never share any
                        personal data.
                    </Text>
                </View>
