/**
 * Home tab: balance, quick actions (Discover, Wallet, Activity), active order, profile avatar.
 * Profile photo is loaded from backend when screen is focused and displayed in the top-right.
 */
    ...
    const devCreateTestOrder = async () => {
        ...
        try {
            ...
            if (data.success) {
                Alert.alert(
                    'Test Order Created!',
                    'Open Rider App and go Online to see this order'
                );
            } else {
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            >
                ...
                >
                    ...
                    <Text style={s.searchInputPlaceholder}>ค้นหาร้านซักรีดที่คุณต้องการ...</Text>
                </TouchableOpacity>
            ...
            <View style={s.gridWrap}>
                <View style={s.gridRow}>
                    <ActionButton
                        ...
                        onPress={() =>
                            router.push({ pathname: '/search', params: { type: 'full' } })
                        }
                    />
                    <ActionButton
                    ...
                    <ActionButton
                        ...
                        onPress={() =>
                            router.push({ pathname: '/search', params: { nearMe: 'true' } })
                        }
                    />
                </View>
                ...
                <View style={s.gridRow}>
                    <ActionButton
                        ...
                        onPress={() =>
                            router.push({ pathname: '/search', params: { type: 'coin' } })
                        }
                    />
                    <ActionButton
