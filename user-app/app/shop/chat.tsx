...
export default function ChatScreen() {
    ...
    const renderMessage = ({ item }: { item: ChatMessage }) => {
        ...
        return (
            <View
                style={[styles.messageRow, isUser ? styles.messageRowUser : styles.messageRowRider]}
            >
                <View style={[styles.bubble, isUser ? styles.bubbleUser : styles.bubbleRider]}>
