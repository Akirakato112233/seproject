        ...
        <Modal animationType="slide" transparent={true} visible={visible} onRequestClose={onClose}>
            ...
            <View style={[styles.bottomSheetContainer, { height: '85%' }]}>
                <View style={styles.modalHeader}>
                    ...
                    <Text style={[styles.bottomSheetTitle, { marginLeft: 15, marginBottom: 0 }]}>
                        Filters
                    </Text>
                </View>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <CheckboxRow
                        ...
                        onPress={() =>
                            setFilters({ ...filters, rating: filters.rating > 0 ? 0 : 4 })
                        }
                        icon="star-outline"
                    />
                    <CheckboxRow
                    ...
                    <View style={styles.priceContainer}>
                        {[1, 2, 3, 4].map((num) => (
                            <TouchableOpacity
                                ...
                                style={[
                                    styles.priceBtnItem,
                                    filters.price === num && styles.priceBtnActive,
                                ]}
                            ...
                            >
                                <Text
                                    style={[
                                        styles.priceBtnText,
                                        filters.price === num && styles.priceBtnTextActive,
                                    ]}
                                >
                                    {'$'.repeat(num)}
                                </Text>
