            ...
            >
                ...
                >
                    <Text
                        style={[
                            styles.chipText,
                            isFilterActive('type', 'all') && styles.activeChipText,
                        ]}
                    >
                        Laundry Type
                    </Text>
                ...
                >
                    <Text style={[styles.chipText, filters.nearMe && styles.activeChipText]}>
                        Near me
                    </Text>
                </TouchableOpacity>
                ...
                >
                    <Text
                        style={[
                            styles.chipText,
                            isFilterActive('rating', 0) && styles.activeChipText,
                        ]}
                    >
                        Rating
                    </Text>
                ...
                >
                    <Text
                        style={[
                            styles.chipText,
                            isFilterActive('price', 0) && styles.activeChipText,
                        ]}
                    >
                        Price
                    </Text>
                ...
                >
                    <Text
                        style={[
                            styles.chipText,
                            isFilterActive('delivery', 'Any') && styles.activeChipText,
                        ]}
                    >
                        Delivery fee
                    </Text>
