...
export interface IOrder extends Document {
    ...
    status: 'decision' | 'accepted' | 'rider_coming' | 'at_shop' | 'out_for_delivery' | 'in_progress' | 'deliverying' | 'completed' | 'cancelled';
...
const OrderSchema: Schema = new Schema({
    ...
    status: {
        type: String,
        enum: ['decision', 'accepted', 'rider_coming', 'at_shop', 'out_for_delivery', 'in_progress', 'deliverying', 'completed', 'cancelled'],
        default: 'decision'
    },
