 ...
 * Query: ?redirect_scheme=exp://192.168.2.37:8081
 */
router.get('/start', (req: Request, res: Response) => {
    res.setHeader('ngrok-skip-browser-warning', '1');
    const redirectScheme = (req.query.redirect_scheme as string) || 'exp://192.168.2.37:8081';
...
router.get('/callback', async (req: Request, res: Response) => {
    try {
        ...
        const redirectScheme = (state as string) || 'exp://192.168.2.37:8081';
        const GOOGLE_CLIENT_ID = '543704041787-0slqpuv7ecelpgsfg73s6gao3qo6geb9.apps.googleusercontent.com';
