    ...
    const renderMessage = ({ item }: { item: ChatMessage }) => {
        ...
        return (
            <View
                style={[
                    styles.messageRow,
                    isRider ? styles.messageRowRider : styles.messageRowCustomer,
                ]}
            >
                <View style={[styles.bubble, isRider ? styles.bubbleRider : styles.bubbleCustomer]}>
                    <Text style={[styles.messageText, isRider && styles.messageTextRider]}>
                        {item.text}
                    </Text>
                    <Text style={[styles.timeText, isRider && styles.timeTextRider]}>
                        {item.createdAt}
                    </Text>
                </View>
            </View>
