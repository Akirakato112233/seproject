    ...
    <SafeAreaView style={s.container} edges={["top"]}>
      ...
      <View style={s.section}>
        ...
        <Text style={s.sectionDesc}>
          I would like to be contacted for customised products or services
          (based on my profile from time to time) and be engaged for marketing
          purposes via:
        </Text>
      </View>
      ...
      {/* Email */}
      <View style={s.row}>
        <Text style={[s.rowLabel, !emailAvailable && { color: "#94A3B8" }]}>
          Email
        </Text>
        <Switch
