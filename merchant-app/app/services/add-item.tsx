  ...
  return (
    <SafeAreaView style={s.safe} edges={['bottom']}>
      <ScrollView style={s.scroll} contentContainerStyle={s.content}>
        <TouchableOpacity style={s.imageUpload}>
          <Ionicons name="add-circle-outline" size={48} color={Colors.textMuted} />
          <Text style={s.imageUploadText}>Add a picture</Text>
        </TouchableOpacity>
        <Text style={s.disclaimer}>
          The shop certifies that the images used do not infringe on the copyright
