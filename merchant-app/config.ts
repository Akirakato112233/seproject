...
// เปลี่ยนใน .env ได้: EXPO_PUBLIC_BASE_URL=https://nonheritably-panpsychistic-joannie.ngrok-free.dev
const NGROK_URL = process.env.EXPO_PUBLIC_BASE_URL || 'https://nonheritably-panpsychistic-joannie.ngrok-free.dev';
